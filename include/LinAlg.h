...
public:
    ...
    Matrix2D(size_t n_rows, size_t n_cols) : n_0(n_rows), n_1(n_cols), stride_0(n_1), stride_1(1), data({})
    {
    ...
    // TODO common operations - add, scale, pointwise, mat-vec, mat-mul, transposition - just change the strides
    Matrix2D &;
};
